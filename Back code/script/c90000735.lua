...
function c90000735.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	...
	e2:SetTarget(c90000735.etarget)
	e2:SetValue(c90000735.efilter)
	c:RegisterEffect(e2)
	...
	e3:SetCondition(c90000735.refcon)
	e3:SetOperation(c90000735.refop)
	c:RegisterEffect(e3)
	...
	e7:SetCondition(c90000735.pencon)
	e7:SetTarget(c90000735.pentg)
	e7:SetOperation(c90000735.penop)
	c:RegisterEffect(e7)
end
--to pendulumZ
function c90000735.pencon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:IsPreviousLocation(LOCATION_MZONE) and c:IsFaceup()
end
function c90000735.pentg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLocation(tp,LOCATION_PZONE,0) or Duel.CheckLocation(tp,LOCATION_PZONE,1) end
end
function c90000735.penop(e,tp,eg,ep,ev,re,r,rp)
...
--protect
function c90000735.etarget(e,c)
	return c:IsSetCard(0x7d0)
end
function c90000735.efilter(e,re)
	return re:GetOwnerPlayer()~=e:GetHandlerPlayer()
end

--reflect damage
function c90000735.refcon(e,tp,eg,ep,ev,re,r,rp)
	local a=Duel.GetAttacker()
	local d=Duel.GetAttackTarget()
	local c=e:GetHandler()
	return (a:IsSetCard(0x7d0) or (d and d:IsSetCard(0x7d0))) and Duel.GetBattleDamage(tp)>0
end
function c90000735.refop(e,tp,eg,ep,ev,re,r,rp)
