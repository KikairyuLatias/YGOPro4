...
function c90000623.initial_effect(c)
   --xyz summon
	...
	e3:SetDescription(aux.Stringid(90000623,0))
	e3:SetType(EFFECT_TYPE_QUICK_O)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCode(EVENT_SUMMON)
	e3:SetCost(c90000623.cost)
	e3:SetTarget(c90000623.target)
	e3:SetOperation(c90000623.operation)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
	e4:SetDescription(aux.Stringid(90000623,1))
	e4:SetCode(EVENT_FLIP_SUMMON)
	c:RegisterEffect(e4)
	local e5=e3:Clone()
	e5:SetDescription(aux.Stringid(90000623,2))
