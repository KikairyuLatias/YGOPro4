...
function c90000511.initial_effect(c)
	...
	e2:SetCountLimit(1,90000511)
	e2:SetTarget(c90000511.target)
	e2:SetOperation(c90000511.operation)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
...
function c90000511.operation(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c90000511.filter,tp,LOCATION_DECK,0,1,1,nil)
