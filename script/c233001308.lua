...
function s.locklimit(e,re,tp)
	return re:IsActiveType(TYPE_MONSTER) and c:IsStatus(STATUS_SUMMON_TURN+STATUS_FLIP_SUMMON_TURN+STATUS_SPSUMMON_TURN)
end
--cut off hands
