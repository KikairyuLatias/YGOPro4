...
function c90000252.initial_effect(c)
	...
	e3:SetCondition(c90000252.descon)
	e3:SetTarget(c90000252.destg)
	e3:SetOperation(c90000252.desop)
	c:RegisterEffect(e3)
end
--make burn
...
function c90000252.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SelectTarget(tp,Card.IsFaceup,tp,LOCATION_MZONE,0,1,nil)
end
