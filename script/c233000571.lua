...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not Duel.IsPlayerAffectedByEffect(tp,59822133)
		...
		and Duel.IsPlayerCanSpecialSummonMonster(tp,233000572,0x43a,0x4011,0,0,3,RACE_BEAST,ATTRIBUTE_FIRE) end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsPlayerCanSpecialSummonMonster(tp,233000572,0x101b,0x4011,0,0,3,RACE_BEAST,ATTRIBUTE_FIRE) then
		local token1=Duel.CreateToken(tp,233000572)
		Duel.SpecialSummonStep(token1,0,tp,tp,false,false,POS_FACEUP)
		local token2=Duel.CreateToken(tp,233000572)
