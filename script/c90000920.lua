...
function c90000920.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(90000920,1))
	...
	e2:SetDescription(aux.Stringid(90000920,2))
	e2:SetCategory(CATEGORY_TOHAND)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_TO_GRAVE)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_DELAY)
	e2:SetTarget(c90000920.thtg)
	e2:SetOperation(c90000920.thop)
	c:RegisterEffect(e2)
end
...
--add card
function c90000920.thfilter(c)
	return c:IsAbleToHand()
end
function c90000920.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c90000920.thfilter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c90000920.thfilter,tp,LOCATION_GRAVE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectTarget(tp,c90000920.thfilter,tp,LOCATION_GRAVE,0,1,1,nil)
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,g,1,0,0)
end
function c90000920.thop(e,tp,eg,ep,ev,re,r,rp)
